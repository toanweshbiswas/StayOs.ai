...
const landlordFeatures: Home[] = [
    { id: 'l1', name: 'Deposit+', description: 'Liquidity unlocked. We refund tenants in 24h, while you earn 12% APY on the deposit corpus.', location: 'Fintech', image: 'https://images.unsplash.com/photo-1554995207-c18c203602cb?auto=format&fit=crop&q=80&w=600', price: '12% Yield', bhk: 0, sqft: 0, availableRooms: 'Asset Class', availableDate: 'Active' },
    { id: 'l2', name: 'Safe+', description: 'Instant credit line against your future rental income. Cash out 12 months of rent today.', location: 'Credit', image: 'https://images.unsplash.com/photo-1565514020176-dbf2277e38c3?auto=format&fit=crop&q=80&w=600', price: 'Instant Limit', bhk: 0, sqft: 0, availableRooms: 'Liquidity', availableDate: 'Active' },
    { id: 'l3', name: 'AutoPilot', description: 'Zero-touch management. We handle sourcing, KYC, agreements, maintenance, and exit.', location: 'Ops', image: 'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?auto=format&fit=crop&q=80&w=600', price: 'Zero Stress', bhk: 0, sqft: 0, availableRooms: 'Managed', availableDate: 'Active' },
];

const tenantFeatures: Home[] = [
    { id: 't1', name: 'Rent+', description: 'Cash crunch? Spot your rent with 0% interest for 15 days or convert to low-cost EMIs.', location: 'Payments', image: 'https://images.unsplash.com/photo-1579621970563-ebec7560ff3e?auto=format&fit=crop&q=80&w=600', price: 'BNPL', bhk: 0, sqft: 0, availableRooms: 'Credit', availableDate: 'Active' },
    { id: 't2', name: 'Nomad', description: 'Traveling? Sublet your room legally through the app and earn back up to 50% of your rent.', location: 'Flexibility', image: 'https://images.unsplash.com/photo-1533105079780-92b9be482077?auto=format&fit=crop&q=80&w=600', price: 'Earn Rent', bhk: 0, sqft: 0, availableRooms: 'Sublet', availableDate: 'Active' },
    { id: 't3', name: 'Concierge', description: 'Housekeeping, laundry, groceries, and repairs. One tap, delivered to your door.', location: 'Service', image: 'https://images.unsplash.com/photo-1584622650111-993a426fbf0a?auto=format&fit=crop&q=80&w=600', price: 'On-Demand', bhk: 0, sqft: 0, availableRooms: 'Lifestyle', availableDate: 'Active' },
];

const businessFeatures: Home[] = [
    { id: 'b1', name: 'Corp OS', description: 'Ditch the hotel. Give your team homes that inspire creativity and foster connection.', location: 'B2B', image: 'https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&q=80&w=600', price: 'Custom', bhk: 0, sqft: 0, availableRooms: 'Housing', availableDate: 'Active' },
    { id: 'b2', name: 'Relocate', description: 'End-to-end relocation for new hires. From airport pickup to a stocked fridge.', location: 'HR Tech', image: 'https://images.unsplash.com/photo-1524758631624-e2822e304c36?auto=format&fit=crop&q=80&w=600', price: 'Seamless', bhk: 0, sqft: 0, availableRooms: 'Onboarding', availableDate: 'Active' },
    { id: 'b3', name: 'Pass', description: 'City-wide access to our lounge network and workspaces for your distributed team.', location: 'Network', image: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&q=80&w=600', price: 'Flexible', bhk: 0, sqft: 0, availableRooms: 'Access', availableDate: 'Active' },
];
