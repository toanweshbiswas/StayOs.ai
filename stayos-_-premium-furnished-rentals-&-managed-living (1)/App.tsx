...
const MainPage = () => (
  <>
    <SEO
      title="StayOs | Premium Furnished Rentals & Managed Living in Bengaluru"
    ...
    <Suspense fallback={<div className="h-96 flex items-center justify-center"><Loader2 className="animate-spin text-teal/20" /></div>}>
      <Stats />
      <Marquee />
      <Security />
      <Neighborhoods />
        ...
        <Suspense fallback={<PageLoader />}>
          <Routes>
            ...
            <Route path="/listings/:id" element={
              <>
                <SEO title="Property Details | StayOs" description="View full details, room photos, and pricing for this premium furnished home." />
                <PropertyDetail />
              </>
            } />
            <Route path="/careers/:id" element={
              <>
                <SEO title="Job Opening | StayOs Careers" description="View job details and apply for this role at StayOs." />
                <JobDetail />
              </>
            } />
